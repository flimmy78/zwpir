        ...
        if(NULL != pTxBuf)
        {
          ...
          for( n = 1; n < handleNbrFirmwareVersions();n++)
          {
            handleGetFirmwareVersion( n,
              (BYTE*)(&(pTxBuf->ZW_VersionReport1byteV2Frame.variantgroup1) + (n-1)*(sizeof(VG_VERSION_REPORT_V2_VG))));
          }
...
/*============================ handleGetFirmwareHwVersion ===================
** Function description
** Read HW_version from NVR-Application area.  It return 0xff if hwVersion
** is not initialized!
**
**-------------------------------------------------------------------------*/
BYTE
