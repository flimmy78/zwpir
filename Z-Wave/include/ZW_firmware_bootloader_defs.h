...
/* NVM offset for the first byte of Firmware Image written/read */
#define FIRMWARE_NVM_OFFSET_1MBIT         0x7800  /* 30 * 1024 */
/* NVM offset for the New Firmware Image present indicator */
#define FIRMWARE_NVM_IMAGE_NEW_1MBIT      (FIRMWARE_NVM_OFFSET_1MBIT - 1)
...
/* Address in NVM where the first byte of the COMMON BANK in Firmware Image resides */
#define FIRMWARE_COMMON_NVM_OFFSET_1MBIT  0x0000
...
/* NVM offset for the first byte of Firmware Image written/read */
#define FIRMWARE_NVM_OFFSET_2MBIT         0x20000  /* 128 * 1024 */
/* NVM offset for the New Firmware Image present indicator */
#define FIRMWARE_NVM_IMAGE_NEW_2MBIT      (FIRMWARE_NVM_OFFSET_2MBIT - 1)
/* Firmware Image address offset of the first byte written/read in the NVM firmware COMMON area */
#define FIRMWARE_START_OFFSET_2MBIT       0x0000
/* Address offset in NVM Firmware Image area where the first byte of the written COMMON BANK in Firmware Image resides */
#define FIRMWARE_COMMON_NVM_OFFSET_2MBIT  FIRMWARE_BOOTLOADER_SIZE
