...
*
* Last Changed By:  $Author: colsen $
* Revision:         $Revision: 34678 $
* Last Changed:     $Date: 2016-11-02 16:49:56 +0100 (on, 02 nov 2016) $
*
****************************************************************************/
...
#ifdef ZW_DEBUG
#ifdef ZM5202
#define ZW_DEBUG_INIT(baud)       {ZW_UART0_zm5202_mode_enable(TRUE);\
                                   ZW_UART0_init(baud, TRUE, FALSE);}
...
**  Enable/Disable UART0 ZM4102 mode.
**  When enabled Tx0 is mapped to IO P3.5 and Rx0 is mapped to IO P3.4
**  When disabled Tx0 is mapped to IO P2.1 and Rx0 is mapped to IO P2.0
**    Side effects:
**  The PWM output is moved to IO P1.0.
**---------------------------------------------------------------------------------------------*/
void
ZW_UART0_zm4102_mode_enable( BYTE bState);  /* IN, TRUE to set the UART0 in ZM4102 mode,*/
                                            /*     FALSE to disable ZM4102 mode*/

#define ZW_UART0_zm5202_mode_enable(bState) ZW_UART0_zm4102_mode_enable(bState)
