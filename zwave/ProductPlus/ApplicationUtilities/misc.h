...
* Last Changed: $Date: 2013/11/13 14:38:44 $
*
****************************************************************************/
#ifndef _MISC_H_
#define _MISC_H_
...
/*=============================   AppPowerDownReady  ========================
**
**    report if the application is ready to go in power down mode.
**  Side effects: None
**
**------------------------------------------------------------------------------*/
extern BYTE AppPowerDownReady(void);
