...
VOID_CALLBACKFUNC(nrCompletedFunc)(BYTE txStatus); /* Completed callback function */
...
extern XBYTE nodeID;                /* This nodes Node-ID */
#else
...
extern VOID_CALLBACKFUNC(cbFuncZWSecure)(BYTE txStatus);
/////////////////////////

  void AES128_Encrypt(const BYTE *ext_input, BYTE *ext_output, const BYTE *ext_key);

  void ZCB_NonceRequestCompleted(BYTE txStatus, void *psTxResult);

  void ZCB_NonceCompleted(BYTE txStatus, void *psTxResult);
