...
**
**  Check if NVM firmware is valid using CRC16 check
**  Uses variables initialized by ZW_FirmwareUpdate_NVM_Init and
**  Firmware Descriptor information in NVM to determine what
**  data should be included in the CRC16 check.
**
**  Pseudocode for CRC16 check
**
**  CRC = NVM_UpdateCRC16(0x1D0F, NVM_FIRMWARE_BANK1_START, NVM_firmwareDescriptor.wFirmWareBank1Size);
**  CRC = NVM_UpdateCRC16(CRC, NVM_FIRMWARE_BANK2_START, NVM_firmwareDescriptor.wFirmWareBank2Size);
**  CRC = NVM_UpdateCRC16(CRC, NVM_FIRMWARE_BANK3_START, NVM_firmwareDescriptor.wFirmWareBank3Size);
**  CRC = NVM_UpdateCRC16(CRC, NVM_FIRMWARE_COMMON_START, NVM_firmwareDescriptor.wFirmWareCommonSize - FIRMWARE_BOOTLOADER_SIZE);
**
**  Side effects:
**    The WORD pCRC points is destroyed and contains the resulting CRC16.
**    This is ZERO if NVM contains a valid Z-Wave Bootloader upgradeable firmware
**
**---------------------------------------------------------------*/
